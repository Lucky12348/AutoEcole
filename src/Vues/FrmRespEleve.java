 ...
 * @author louis
 */
public class FrmRespEleve extends javax.swing.JFrame {

    /**
     * Creates new form FrmRespSommaire
     */
    public FrmRespEleve(User unUser) {
        initComponents();
        leUser = unUser;
    }
    ...
    private void initComponents() {
        ...
        btnEleve.setBackground(new java.awt.Color(0, 255, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRespEleve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRespEleve(leUser).setVisible(true);
            }
        });
    }
